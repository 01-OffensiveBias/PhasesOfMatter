...
function Dots(num, grav, fric, speed, bounce) {
    ...
    this.dotsize = new Float32Array(length / 2);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, this.dotsize, gl.STATIC_DRAW);

    var aPointSize = gl.getAttribLocation(glProgram, 'aPointSize');
